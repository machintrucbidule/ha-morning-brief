...
- [ ] Tag v1.0.0-rc.9 (pool partagé refactor — D12 override per DECISIONS.md; migration auto from per-instance subentries to shared pool)
- [ ] Tag v1.0.0 (after pool migration + full live-HA validation)
